...
- (void)drawAmsterdamPolygon {
    ...
    TTPolygon *polygon = [TTPolygon polygonWithCoordinates:coordinates count:pointsCount opacity:0.5 color:color colorOutline:color];
...
- (void)drawAmsterdamCircle:(CLLocationCoordinate2D)coordinate withRadius:(double)radius {
    ...
    TTCircle *circle = [TTCircle circleWithCenterCoordinate:coordinate radius:radius opacity:0.5 width:10 color:color fill:YES colorOutlet:color];
