...
- (UITableViewCell *)tableView:(UITableView *)tableView
  ...
  if ([self.results[indexPath.row] isKindOfClass:[NSString class]]) {
    ...
    ManeuverCell *maneuverCell =
        [NSBundle.mainBundle loadNibNamed:@"ManeuverCell"
                                    owner:self
                                  options:nil]
            .firstObject;
    ...
    maneuverCell.maneuverDistance.text =
        distanceToManeuver > 1000
            ? [NSString stringWithFormat:@"(%d) km", distanceToManeuver / 1000]
            : [NSString stringWithFormat:@"(%d) m", distanceToManeuver];
    ...
    NSString *text =
        [NSString stringWithFormat:@"(%.1f km) %@ %@ %@", distance,
