...
- (void)setupCollectionView {
    ...
    [collectionView registerClass:[UICollectionViewCell class] forCellWithReuseIdentifier:reusableID];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    UICollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:reusableID forIndexPath:indexPath];
    UIImageView *imageView = [self getImageViewForIndex:indexPath.row];
    imageView.translatesAutoresizingMaskIntoConstraints = NO;
    [cell addSubview:imageView];
    [cell addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-0-[v0]-0-|" options:0 metrics:nil views:@{@"v0" : imageView}]];
    [cell addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-0-[v0]-0-|" options:0 metrics:nil views:@{@"v0" : imageView}]];
    return cell;
}
