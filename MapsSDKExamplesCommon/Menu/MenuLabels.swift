...
public class MenuLabels: NSObject {
    ...
    public static let valueArray = [Options(category: .Map,
                                            ...
                                            subOptions: [SubOptions(iconImage: "map_tiles_image",
                                                         ...
                                                         SubOptions(iconImage: "poi_layers_image",
                                                                    titleLabel: "POI layers visibility",
                                                                    subtitleLabel: "Display on the map various categories of POI’s with corresponding labels and icons."),
                                                         ...
                                                         SubOptions(iconImage: "trafficalongRroute_image",
                                                                    titleLabel: "Traffic along the route",
                                                                    subtitleLabel: "Traffic information to support the user with planning the route regarding traffic jam conditions and timing.")]),
                                    ...
                                    Options(category: .Driving,
                                            ...
                                            subOptions: [SubOptions(iconImage: "map_follow_chevron_image",
                                                         ...
                                                         SubOptions(iconImage: "zooming_the_route",
                                                                    titleLabel: "Zooming the route",
                                                                    subtitleLabel: "Zooming in and out in accordance with vehicle velocity.")]),
                                    Options(category: .Search,
                                            ...
                                            subOptions: [SubOptions(iconImage: "adress_search_image",
                                                         ...
                                                         SubOptions(iconImage: "POIDetailsandPhotos",
                                                                    titleLabel: "POI details and photos",
                                                                    subtitleLabel: "Display Photos and add Details to the POIs in your app.")]),
