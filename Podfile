...
def tomtom_pods
  ...
  pod 'TomTomOnlineSDKMapsStaticImage', '2.4.694'
  pod 'TomTomOnlineSDKTraffic', '2.4.694'
  pod 'TomTomOnlineSDKMapsDriving', '2.4.694'
  pod 'TomTomOnlineSDKGeofencing', '2.4.694'
end
