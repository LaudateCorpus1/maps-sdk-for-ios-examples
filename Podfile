...
def tomtom_pods
  ...
  pod 'TomTomOnlineSDKMapsStaticImage', '2.4.699'
  pod 'TomTomOnlineSDKTraffic', '2.4.699'
  pod 'TomTomOnlineSDKMapsDriving', '2.4.699'
  pod 'TomTomOnlineSDKGeofencing', '2.4.699'
end
