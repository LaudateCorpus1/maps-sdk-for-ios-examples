...
def tomtom_pods
  ...
  pod 'TomTomOnlineSDKMapsStaticImage', '2.4.464'
  pod 'TomTomOnlineSDKTraffic', '2.4.464'
  pod 'TomTomOnlineSDKMapsDriving', '2.4.464'
  pod 'TomTomOnlineSDKGeofencing', '2.4.464'
end
