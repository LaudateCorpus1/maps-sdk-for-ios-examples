...
- (void)searchForParking {
    TTGeometrySearchQuery *query = [[[TTGeometrySearchQueryBuilder createWithTerm:@"Parking" searchShapes:self.geometryShape]
                                     withLimit:30]
                                    build];
...
- (void)searchForATM {
    TTGeometrySearchQuery *query = [[[TTGeometrySearchQueryBuilder createWithTerm:@"ATM" searchShapes:self.geometryShape]
                                     withLimit:30]
                                    build];
    [self.geometrySearch searchWithQuery:query];
}
...
- (void)searchForGrocery {
    TTGeometrySearchQuery *query = [[[TTGeometrySearchQueryBuilder createWithTerm:@"Grocery" searchShapes:self.geometryShape]
                                     withLimit:30]
                                    build];
    [self.geometrySearch searchWithQuery:query];
}
