...
- (OptionsView *)getOptionsView {
    return [[OptionsViewSingleSelect alloc] initWithLabels:@[ @"Simple", @"Custom" ] selectedID:-1];
}
...
- (void)displaySimpleBallon {
    TTAnnotation *annotation = [TTAnnotation annotationWithCoordinate:[TTCoordinate AMSTERDAM]];
