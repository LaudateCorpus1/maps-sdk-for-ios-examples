...
- (void)routeSegmentedPlanned:(TTFullRoute *)plannedRoute {
    ...
    TTMapRouteStyle *routeStyle1 = [[[[[TTMapRouteStyleBuilder new]
                          withWidth:1.0]
                         withFillColor:UIColor.blackColor]
                        withOutlineColor:UIColor.blackColor]
                       build];
    ...
    TTMapRouteStyle *routeStyle2 = [[[[[TTMapRouteStyleBuilder new]
                                     ...
                                     withOutlineColor:UIColor.blueColor]
                                    build];
    ...
    // Section 3
    TTMapRouteStyle *routeStyle3 = [[[[[TTMapRouteStyleBuilder new]
                                       withWidth:1.0]
...
- (void)planSegmentedRoute {
    TTRouteQuery *query = [[[[TTRouteQueryBuilder createWithDest:[TTCoordinate AMSTERDAM] andOrig:[TTCoordinate LODZ]]
                             withSectionType:TTSectionTypeCountry]
                            withTraffic:NO]
                           build];
    [self.routePlanner planRouteWithQuery:query];
}
