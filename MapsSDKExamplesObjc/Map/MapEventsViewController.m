...
- (void)toast:(NSString *)message coordinate:(CLLocationCoordinate2D)coordinate {
    [self.toast toastWithMessage:[NSString stringWithFormat:@"%@ %.5f %.5f", message, coordinate.latitude, coordinate.longitude]];
}
