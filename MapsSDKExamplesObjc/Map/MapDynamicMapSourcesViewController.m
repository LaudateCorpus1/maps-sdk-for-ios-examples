...
- (void)setupInitialCameraPosition {
    [self.mapView centerOnCoordinate:[TTCoordinate BUCKINGHAM_PALACE_CENTER] withZoom:16];
}

- (OptionsView *)getOptionsView {
    return [[OptionsViewMultiSelect alloc] initWithLabels:@[ @"GeoJson", @"Image" ] selectedID:-1];
}
