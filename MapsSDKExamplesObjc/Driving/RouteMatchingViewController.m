...
- (void)setupInitialCameraPosition {
    [self.mapView centerOnCoordinate:TTCoordinate.LODZ_SREBRZYNSKA_START withZoom:18];
}
...
- (void)start {
    ...
    TTLocation *startLocation = [[TTLocation alloc] initWithCoordinate:TTCoordinate.LODZ_SREBRZYNSKA_START];
