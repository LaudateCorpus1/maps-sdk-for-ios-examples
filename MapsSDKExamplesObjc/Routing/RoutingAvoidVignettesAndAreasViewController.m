...
- (void)displayRoute:(NSString *)etaView plannedRoute:(TTFullRoute *)plannedRout routeStyle:(TTMapRouteStyle *)routeStyle {
    TTMapRoute *mapRoute = [TTMapRoute routeWithCoordinatesData:plannedRout withRouteStyle:routeStyle imageStart:[TTMapRoute defaultImageDeparture] imageEnd:[TTMapRoute defaultImageDestination]];
...
- (TTMapRouteStyle *)setRouteStyle:(UIColor *)fillColor outlineColor:(UIColor *)outlineColor {
    TTMapRouteStyle *routeStyle = [[[[[[TTMapRouteStyleBuilder alloc] init] withWidth:1.0] withFillColor:fillColor] withOutlineColor:outlineColor] build];
    return routeStyle;
}
