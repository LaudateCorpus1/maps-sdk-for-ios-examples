...
@interface RoutingConsumptionModelViewController() <TTRouteResponseDelegate, TTRouteDelegate>
...
- (OptionsView *)getOptionsView {
    return [[OptionsViewSingleSelect alloc] initWithLabels:@[@"Combustion", @"Electric"] selectedID:-1];
}
...
- (void)displayCombustionRoute {
    ...
    TTRouteQuery * query = [[[[[[[[[[[[[TTRouteQueryBuilder createWithDest:[TTCoordinate UTRECHT] andOrig:[TTCoordinate AMSTERDAM]]
                              ...
                              withSpeedConsumptionInLitersPairs:speedConsumptionInLiters count:7]
                             build];
...
- (void)displayElectricRoute {
    ...
    TTRouteQuery * query = [[[[[[[[[[[[[TTRouteQueryBuilder createWithDest:[TTCoordinate UTRECHT] andOrig:[TTCoordinate AMSTERDAM]]
                               ...
                               withSpeedConsumptionInkWhPairs:speedConsumptionInkWh count:6]
                              build];
    [self.routePlanner planRouteWithQuery:query];
}
