...
typedef NS_ENUM(NSInteger, BatchRouteType) { BatchRouteTypeTravelMode, BatchRouteTypeRoute, BatchRouteTypeAvoids } BatchRouteSectionType;
...
- (void)setupDict {
    self.routeDesc = @{@(BatchRouteTypeTravelMode) : @[ @"Travel by Car", @"Travel by Truck", @"Travel by Pedestrian" ], @(BatchRouteTypeRoute) : @[ @"Fastest route", @"Shortest route", @"Eco route" ], @(BatchRouteTypeAvoids) : @[ @"Avoid motorways", @"Avoid ferries", @"Avoid toll roads" ]};
}
...
- (void)performTravelMode {
    ...
    TTRouteQuery *queryCar = [[[[[TTRouteQueryBuilder createWithDest:[TTCoordinate ROTTERDAM] andOrig:[TTCoordinate AMSTERDAM]] withComputeBestOrder:YES] withTraffic:YES] withTravelMode:TTOptionTravelModeCar] build];
    TTRouteQuery *queryTruck = [[[[[TTRouteQueryBuilder createWithDest:[TTCoordinate ROTTERDAM] andOrig:[TTCoordinate AMSTERDAM]] withComputeBestOrder:YES] withTraffic:YES] withTravelMode:TTOptionTravelModeTruck] build];
...
- (void)performRouteType {
    ...
    TTRouteQuery *queryFastest = [[[[[TTRouteQueryBuilder createWithDest:[TTCoordinate ROTTERDAM] andOrig:[TTCoordinate AMSTERDAM]] withComputeBestOrder:YES] withTraffic:YES] withRouteType:TTOptionTypeRouteFastest] build];
    TTRouteQuery *queryShortest = [[[[[TTRouteQueryBuilder createWithDest:[TTCoordinate ROTTERDAM] andOrig:[TTCoordinate AMSTERDAM]] withComputeBestOrder:YES] withTraffic:YES] withRouteType:TTOptionTypeRouteShortest] build];
...
- (void)performAvoids {
    ...
    TTRouteQuery *queryMotorways = [[[[[TTRouteQueryBuilder createWithDest:[TTCoordinate OSLO] andOrig:[TTCoordinate AMSTERDAM]] withComputeBestOrder:YES] withTraffic:YES] withAvoidType:TTOptionTypeAvoidMotorways] build];
    TTRouteQuery *queryFerries = [[[[[TTRouteQueryBuilder createWithDest:[TTCoordinate OSLO] andOrig:[TTCoordinate AMSTERDAM]] withComputeBestOrder:YES] withTraffic:YES] withAvoidType:TTOptionTypeAvoidFerries] build];
