...
@interface RoutingBatchRouteViewController () <TTBatchRouteResponseDelegate, TTBatchRouteVisistor, TTRouteDelegate>
...
- (void)setupDict {
    self.routeDesc = @{ @(BatchRouteTypeTravelMode) :  @[@"Travel by Car", @"Travel by Truck", @"Travel by Pedestrian"],
                        @(BatchRouteTypeRoute): @[@"Fastest route", @"Shortest route", @"Eco route"],
                        @(BatchRouteTypeAvoids): @[@"Avoid motorways", @"Avoid ferries", @"Avoid toll roads"]
                        };
}

- (OptionsView *)getOptionsView {
    return [[OptionsViewSingleSelect alloc] initWithLabels:@[@"Travel mode",@"Route type", @"Avoids"] selectedID:-1];
}
...
- (void)performTravelMode {
    ...
    TTRouteQuery *queryCar = [[[[[TTRouteQueryBuilder createWithDest:[TTCoordinate ROTTERDAM] andOrig:[TTCoordinate AMSTERDAM]]
                                 withComputeBestOrder:YES]
                                withTraffic:YES]
                               withTravelMode:TTOptionTravelModeCar]
                              build];
    TTRouteQuery *queryTruck = [[[[[TTRouteQueryBuilder createWithDest:[TTCoordinate ROTTERDAM] andOrig:[TTCoordinate AMSTERDAM]]
                                   withComputeBestOrder:YES]
                                  withTraffic:YES]
                                 withTravelMode:TTOptionTravelModeTruck]
                                build];
    TTRouteQuery *queryPedestrain = [[[[[TTRouteQueryBuilder createWithDest:[TTCoordinate ROTTERDAM] andOrig:[TTCoordinate AMSTERDAM]]
                                        withComputeBestOrder:YES]
                                       withTraffic:YES]
                                      withTravelMode:TTOptionTravelModePedestrian]
                                     build];
    TTBatchRouteQuery *batchQuery = [[[[TTBatchRouteQueryBuilder createRouteQuery:queryCar]
                                       addRouteQuery:queryTruck]
                                      addRouteQuery:queryPedestrain]
                                     build];
...
- (void)performRouteType {
    ...
    TTRouteQuery *queryFastest = [[[[[TTRouteQueryBuilder createWithDest:[TTCoordinate ROTTERDAM] andOrig:[TTCoordinate AMSTERDAM]]
                                     withComputeBestOrder:YES]
                                    withTraffic:YES]
                                   withRouteType:TTOptionTypeRouteFastest]
                                  build];
    TTRouteQuery *queryShortest = [[[[[TTRouteQueryBuilder createWithDest:[TTCoordinate ROTTERDAM] andOrig:[TTCoordinate AMSTERDAM]]
                                      withComputeBestOrder:YES]
                                     withTraffic:YES]
                                    withRouteType:TTOptionTypeRouteShortest]
                                   build];
    TTRouteQuery *queryEco = [[[[[TTRouteQueryBuilder createWithDest:[TTCoordinate ROTTERDAM] andOrig:[TTCoordinate AMSTERDAM]]
                                 withComputeBestOrder:YES]
                                withTraffic:YES]
                               withRouteType:TTOptionTypeRouteEco]
                              build];
    
    TTBatchRouteQuery *batchQuery = [[[[TTBatchRouteQueryBuilder createRouteQuery:queryFastest]
                                       addRouteQuery:queryShortest]
                                      addRouteQuery:queryEco]
                                     build];
    self.batchRoute = [[TTBatchRoute alloc] init];
    self.batchRoute.delegate = self;
    [self.batchRoute batchRouteWithQuery:batchQuery];
...
- (void)performAvoids {
    ...
    TTRouteQuery *queryMotorways = [[[[[TTRouteQueryBuilder createWithDest:[TTCoordinate OSLO] andOrig:[TTCoordinate AMSTERDAM]]
                                       withComputeBestOrder:YES]
                                      withTraffic:YES]
                                     withAvoidType:TTOptionTypeAvoidMotorways]
                                    build];
    TTRouteQuery *queryFerries = [[[[[TTRouteQueryBuilder createWithDest:[TTCoordinate OSLO] andOrig:[TTCoordinate AMSTERDAM]]
                                     withComputeBestOrder:YES]
                                    withTraffic:YES]
                                   withAvoidType:TTOptionTypeAvoidFerries]
                                  build];
    TTRouteQuery *queryTollRoads = [[[[[TTRouteQueryBuilder createWithDest:[TTCoordinate OSLO] andOrig:[TTCoordinate AMSTERDAM]]
                                       withComputeBestOrder:YES]
                                      withTraffic:YES]
                                     withAvoidType:TTOptionTypeAvoidTollRoads]
                                    build];
    
    TTBatchRouteQuery *batchQuery = [[[[TTBatchRouteQueryBuilder createRouteQuery:queryMotorways]
                                       addRouteQuery:queryFerries]
                                      addRouteQuery:queryTollRoads]
                                     build];
    self.batchRoute = [[TTBatchRoute alloc] init];
    self.batchRoute.delegate = self;
    [self.batchRoute batchRouteWithQuery:batchQuery];
