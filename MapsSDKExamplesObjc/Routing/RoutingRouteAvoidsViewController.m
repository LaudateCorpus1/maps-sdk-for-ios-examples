...
- (void)displayAvoidTollRoadsRoute {
    TTRouteQuery *query = [[[TTRouteQueryBuilder createWithDest:[TTCoordinate OSLO] andOrig:[TTCoordinate AMSTERDAM]] withAvoidType:TTOptionTypeAvoidTollRoads] build];
    [self.routePlanner planRouteWithQuery:query];
}

- (void)displayAvoidFerriesRoute {
    TTRouteQuery *query = [[[TTRouteQueryBuilder createWithDest:[TTCoordinate OSLO] andOrig:[TTCoordinate AMSTERDAM]] withAvoidType:TTOptionTypeAvoidFerries] build];
    [self.routePlanner planRouteWithQuery:query];
}
